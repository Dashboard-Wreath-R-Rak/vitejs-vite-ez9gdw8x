...
| บันทึกงาน (แอปมือถือ) | หน้าจอแบบแอปโทรศัพท์ (บนคอมแสดงในกรอบโทรศัพท์จำลอง): 4 ขั้น ที่ไหน → งานอะไร → อะไหล่ → ผู้รับผิดชอบ, ปุ่มใหญ่ใช้มือเดียวได้, bottom sheet เลือกอะไหล่/เครื่อง, หน้ายืนยันหลังบันทึก · F1 เช็ก Job ซ้ำ + รูปแบบ YY/NNN, รหัสอะไหล่ต้องมีใน master, เลือกคนจาก Staff · F4 รหัสเครื่อง / เปิดจาก QR · F7 AI แนะนำประเภท/สถานที่/เครื่อง/อะไหล่ |
